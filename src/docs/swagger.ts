  ...
  components: {
    ...
    schemas: {
      ...
      IkuResult: {
        type: "object",
        properties: {
          idResult: { type: "string", format: "uuid" },
          idIku: { type: "string", format: "uuid" },
          month: { type: "integer" },
          year: { type: "integer" },
          resultType: { type: "string", enum: ["monthly", "quarterly", "yearly"] },
          quarter: { type: "integer", nullable: true },
      ...
      IkuResultCreate: {
        ...
        properties: {
          ...
          month: { type: "integer" },
          year: { type: "integer" },
          resultType: { type: "string", enum: ["monthly", "quarterly", "yearly"], description: "Default is monthly" },
          quarter: { type: "integer", nullable: true },
  ...
  paths: {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            description: "Filter by IKU ID. If the IKU is Direct Input, it returns the IKU. If it has components, it returns the linked components.",
          },
        ],
        responses: {
          "200": {
    ...
    "/api/iku-results": {
      ...
      get: {
        ...
        parameters: [
          { name: "idIku", in: "query", schema: { type: "string", format: "uuid" } },
          { name: "month", in: "query", schema: { type: "integer" } },
          { name: "year", in: "query", schema: { type: "integer" } },
          { name: "resultType", in: "query", schema: { type: "string", enum: ["monthly", "quarterly", "yearly"] } },
