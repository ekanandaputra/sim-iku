  ...
  components: {
    ...
    schemas: {
      ...
      Period: {
        ...
        required: ["id_period", "year", "period_type", "period_value", "period_name", "level"],
      },
      PeriodCreate: {
        type: "object",
        properties: {
      ...
      ComponentRealization: {
        type: "object",
        properties: {
          id_realization: { type: "integer" },
          id_component: { type: "string" },
          id_period: { type: "integer" },
          value: { type: "number" },
          created_at: { type: "string", format: "date-time" },
          updated_at: { type: "string", format: "date-time" },
        ...
        required: ["id_realization", "id_component", "id_period", "value"],
      },
      ComponentRealizationCreate: {
        type: "object",
        properties: {
          idComponent: { type: "string" },
          idPeriod: { type: "integer" },
          value: { type: "number" },
        },
      ...
      IkuResult: {
        ...
        required: ["id_result", "id_iku", "id_period", "calculated_value", "calculated_at"],
      },
      IkuResultCreate: {
        type: "object",
        properties: {
    ...
    "/api/component-realizations": {
      ...
      get: {
        ...
        parameters: [
          ...
          { name: "idPeriod", in: "query", schema: { type: "integer" } },
        ],
